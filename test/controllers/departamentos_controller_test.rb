...
class DepartamentosControllerTest < ActionController::TestCase
  ...
  test "should create departamento" do
    assert_difference('Departamento.count') do
      post :create, departamento: { codigo: @departamento.codigo, descripcion: @departamento.descripcion, nombre: @departamento.nombre }
    end
  ...
  test "should update departamento" do
    patch :update, id: @departamento, departamento: { codigo: @departamento.codigo, descripcion: @departamento.descripcion, nombre: @departamento.nombre }
    assert_redirected_to departamento_path(assigns(:departamento))
  end
