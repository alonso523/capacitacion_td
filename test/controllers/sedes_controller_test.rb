...
class SedesControllerTest < ActionController::TestCase
  ...
  test "should create sede" do
    assert_difference('Sede.count') do
      post :create, sede: { codigo: @sede.codigo, descripcion: @sede.descripcion, nombre: @sede.nombre }
    end
  ...
  test "should update sede" do
    patch :update, id: @sede, sede: { codigo: @sede.codigo, descripcion: @sede.descripcion, nombre: @sede.nombre }
    assert_redirected_to sede_path(assigns(:sede))
  end
