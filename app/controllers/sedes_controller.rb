class SedesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @sede.save
        format.html { redirect_to @sede, notice: 'La Sede fue creada exitosamente.' }
  ...
  def update
    respond_to do |format|
      if @sede.update(sede_params)
        format.html { redirect_to @sede, notice: 'La Sede fue actualizada exitosamente.' }
  ...
  def destroy
    @sede.destroy
    respond_to do |format|
      format.html { redirect_to sedes_url, notice: 'La Sede fue eliminada exitosamente.' }
  ...
  private
    ...
    def sede_params
      params.require(:sede).permit(:codigo, :nombre, :descripcion)
    end
end
