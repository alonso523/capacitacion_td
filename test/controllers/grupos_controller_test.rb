...
class GruposControllerTest < ActionController::TestCase
  ...
  test "should create grupo" do
    assert_difference('Grupo.count') do
      post :create, grupo: { asistente_id: @grupo.asistente_id, curso_id: @grupo.curso_id, descripcion: @grupo.descripcion, profesor_id: @grupo.profesor_id, sede_id: @grupo.sede_id }
    end
  ...
  test "should update grupo" do
    patch :update, id: @grupo, grupo: { asistente_id: @grupo.asistente_id, curso_id: @grupo.curso_id, descripcion: @grupo.descripcion, profesor_id: @grupo.profesor_id, sede_id: @grupo.sede_id }
    assert_redirected_to grupo_path(assigns(:grupo))
  end
