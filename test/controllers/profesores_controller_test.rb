...
class ProfesoresControllerTest < ActionController::TestCase
  ...
  test "should create profesore" do
    assert_difference('Profesore.count') do
      post :create, profesore: { apellido: @profesore.apellido, nombre: @profesore.nombre, observacion: @profesore.observacion }
    end
  ...
  test "should update profesore" do
    patch :update, id: @profesore, profesore: { apellido: @profesore.apellido, nombre: @profesore.nombre, observacion: @profesore.observacion }
    assert_redirected_to profesore_path(assigns(:profesore))
  end
